...
export default function KemalpasaPerdeciPage() {
  return (
    <main className="min-h-screen bg-white">
      {/* Header */}
      <section className="bg-primary text-primary-foreground py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-3">Kemalpaşa Perdeci</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={s.slug} className="rounded-2xl border border-slate-200 p-5 shadow-sm">
              ...
              <p className="text-slate-600 mt-1 text-sm">{s.desc} — Kemalpaşa & Ulucak</p>
            ...
            {[
              {
                ...
                a: 'Evet, Kemalpaşa ve çevresinde ücretsiz keşif/ölçü hizmeti veriyoruz.',
              },
              {
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Evet, Kemalpaşa ve çevresinde ücretsiz keşif/ölçü hizmeti veriyoruz.',
                },
              },
              {
                '@type': 'Question',
